...
while running:
    ...
    if state_current == "state_init":
        ...
        # once space is pressed, current state is inter trial interval
        if resp == pygame.K_SPACE:
            time_state = 0
            resp = -1
            # changing state_iti to state_cue to pop the cue in first
    ...
    # popping cue before fixation cross
    ...
    if state_current == "state_iti":
        ...
        # if time_state is less than 1000ms -> iti
        # going to try and swap fixation and cue around
        # changed to 2000ms (which is what cue was set to
